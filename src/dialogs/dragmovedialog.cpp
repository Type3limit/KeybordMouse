...
DragMoveWidget::DragMoveWidget(QWidget* parent):QDialog(parent),
m_frameLess(nullptr)
{

}

DragMoveWidget::DragMoveWidget(bool resizeable, QWidget* parent):
QDialog(parent),
...
void DragMoveWidget::mouseMoveEvent(QMouseEvent* e)
{
...
void DragMoveWidget::mousePressEvent(QMouseEvent* e)
{
    if (e->button() != Qt::LeftButton)
    {
        return;
...
void DragMoveWidget::mouseReleaseEvent(QMouseEvent* e)
{
    if (e->button() != Qt::LeftButton)
    {
        return;
