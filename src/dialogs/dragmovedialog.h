...
class DragMoveWidget:public QDialog
{
public:
    DragMoveWidget(QWidget* parent=nullptr);
    DragMoveWidget(bool resizeable,QWidget* parent=nullptr);
protected:
    virtual ~DragMoveWidget() = default;
